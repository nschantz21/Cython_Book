...
static const char __pyx_k_mt_random[] = "mt_random";
static const char __pyx_k_init_state[] = "init_state";
static const char __pyx_k_home_ubuntu_workspace_MTGP_mt_r[] = "/home/ubuntu/workspace/MTGP/mt_random.pyx";
static PyObject *__pyx_kp_s_home_ubuntu_workspace_MTGP_mt_r;
...
static char __pyx_doc_9mt_random_init_state[] = "\n    simply wrapping the C function with a python def\n    ";
...
static PyObject *__pyx_pw_9mt_random_1init_state(PyObject *__pyx_self, PyObject *__pyx_arg_s) {
  ...
  assert(__pyx_arg_s); {
    __pyx_v_s = __Pyx_PyInt_As_unsigned_long(__pyx_arg_s); if (unlikely((__pyx_v_s == (unsigned long)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
  }
...
static PyMethodDef __pyx_mdef_9mt_random_3rand = {"rand", (PyCFunction)__pyx_pw_9mt_random_3rand, METH_NOARGS, 0};
 ...
 */
  ...
  __pyx_t_1 = PyFloat_FromDouble(genrand_real1()); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_s_home_ubuntu_workspace_MTGP_mt_r, __pyx_k_home_ubuntu_workspace_MTGP_mt_r, sizeof(__pyx_k_home_ubuntu_workspace_MTGP_mt_r), 0, 0, 1, 0},
 ...
 *     simply wrapping the C function with a python def
 */
  __pyx_tuple_ = PyTuple_Pack(2, __pyx_n_s_s, __pyx_n_s_s); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(1, 0, 2, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_ubuntu_workspace_MTGP_mt_r, __pyx_n_s_init_state, 9, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 9, __pyx_L1_error)
 ...
 *     return genrand_real1()
 */
  __pyx_codeobj__3 = (PyObject*)__Pyx_PyCode_New(0, 0, 0, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_ubuntu_workspace_MTGP_mt_r, __pyx_n_s_rand, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__3)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "mt_random")) {
      if (unlikely(PyDict_SetItemString(modules, "mt_random", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     simply wrapping the C function with a python def
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9mt_random_1init_state, NULL, __pyx_n_s_mt_random); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_init_state, __pyx_t_1) < 0) __PYX_ERR(0, 9, __pyx_L1_error)
 ...
 *     return genrand_real1()
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9mt_random_3rand, NULL, __pyx_n_s_mt_random); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
